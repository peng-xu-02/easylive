...
//TODO 记得来改
        try {
            ...
            redisUtil.setExValue(Conponent.TOKEN + role + ":" + uid, token, JwtUtil.JWT_TTL, TimeUnit.MILLISECONDS);
        } catch (Exception e) {
...
//            log.error("获取token信息失败", e);
    ...
    public boolean verifyToken(String token) {
        ...
        String cacheToken;
        try {
            cacheToken = String.valueOf(redisUtil.getValue(Conponent.TOKEN + role + ":" + uid));
        } catch (Exception e) {
            cacheToken = null;
